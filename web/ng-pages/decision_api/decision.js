...
function DecisionApiFindLikeCtrl($scope, $route, $http, $timeout){
    var self = this;

self.url = '/decision/full-api/find-like';
    ...
    self.post_params = {
        issue_like: {
            key: "BANNERTYPE-27",
//            'description': 'Система автоматизованого проектування і розрахунку — комп\'ютерна система обробки інформації, що призначена для автоматизованого проектування (CAD), розроблення(CAE) і виготовлення (CAM) кінцевого продукту, а також оформлення конструкторської і/або технологічної документації.',
        },
        jql: "project=\"BANNERTYPE\"",
        issue_arr: {
            1: {
...
angular.module('app.decisionApi', ['ngRoute'])
        ...
        .controller('DecisionApiFindLikeCtrl', DecisionApiFindLikeCtrl)
